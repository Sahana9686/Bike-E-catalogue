...
<body class="home">
    ...
    <script>alert('Spare Part Added Sucessfully..!');</script>
    <%}%>
  ...
  <ul class="nav">
    ...
    <a class="dropdown-toggle active" data-toggle="dropdown" href="#">Spare Parts <b class="caret"></b></a>
    <ul class="dropdown-menu">
    ...
    <center>
    <p><font size="4" color="red">Add Spare Parts </font></p><br/>   
    
    <form name="myform" action="addsparesact.jsp" method="post">
    ...
    <%}%>
     ...
     <tr>
    <td height="43"><font size="2">Part Name </td>
    <td><font size="2"><input type="text" id="pic" name="pname" required=""/></td>
    </tr>
<tr><td width="191" height="43"><font size="2"> Color </td>
    ...
    <tr>
    <td height="43"><font size="2">Part Price </td>
    <td><font size="2"><input type="text" id="pic" name="price" required=""/></td>
    </tr>
