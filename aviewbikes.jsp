...
<body class="home">
 ...
 <ul class="nav">
    ...
    <%
        ...
        String sql2="select * from bikes"; 
	Statement st2=connection.createStatement();
	ResultSet rs1=st2.executeQuery(sql2);
	%>
        
         <center>
        <h2><font color="black" size="5"> View My Orders</font></h2>
        <br/>
        <style>
            td{
                text-align: center;
     ...
     <tr>
    <td><font color="black"><%=rs1.getString("brand")%></td>
    <td><font color="black"><%=rs1.getString("bike")%></td>
    <td><font color="black"><textarea><%=rs1.getString(4)%></textarea></td>
    <td><font color="black"><%=rs1.getString(5)%></td>
    <td><font color="black"><img src="Gallery/<%=rs1.getString(7)%>"></img></td>
