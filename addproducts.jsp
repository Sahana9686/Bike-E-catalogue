...
<body class="home">
    ...
    <center>
    <p><font size="4" color="red">Add Bikes</font></p><br/>   
    
    <form name="myform" action="addproductsact.jsp" method="post">
    ...
    <option value="BAJAJ">BAJAJ</option> <option value="TV's">ROYAL ENFIELD</option> 
    </select>
    </td></tr>
    ...
    <tr>
    <td width="191" height="43"><font size="2"> Show Room </td>
    <td width="218"><input type="text" name="sr" required="" style="width: 142px" /></td></tr>
    
    <tr>
    <td width="191" height="43"><font size="2"> Location </td>
    <td width="218"><input type="text" name="loc" required="" style="width: 142px" /></td></tr>

    <tr><td width="191" height="43"><font size="2"> Specifications </td>
    ...
    <tr>
    <td width="191" height="43"><font size="2"> Price </td>
