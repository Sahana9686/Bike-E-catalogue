...
<body class="home">
    ...
    <center>
    <p><font size="5" color="red"> Show oom </font></p><br/>   
    ...
    String keyword = request.getParameter("bikename");
        ...
        PreparedStatement ps = connection.prepareStatement("select * from bikes where sr = '"+keyword+"'");
    ...
    %>
            ...
            <figure> 
                <img height="400" width="300" src="Gallery/<%=rs6.getString("image")%>" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				 ...
				 <span class="style8">Bike : <span class="style27"><%=rs6.getString("bike")%></span></span><br />
                                 ...
                                 <span class="style8">Specifications : <span class="style27"><textarea><%=rs6.getString("description")%></textarea></span></span><br />
