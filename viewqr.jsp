...
<body class="home">
    ...
    <br/>
    <center><p><font color="black" size="5"> Search Bikes for Qr Code</font></p></center>

    <center>
    <form name="myform" action="viewqr1.jsp" method="post">
    <table border="0" >

    <tr><td><font color="black"> Bike Name</td><td><input type="text" autocomplete="off" name="bikename" required="" Placeholder="Bike Name" /></td></tr>
